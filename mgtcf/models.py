...
class Encoder(nn.Module):
    ...
    def forward(self, obs_traj,obs_date_mask):
        """
        Inputs:
...
class Decoder(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, last_pos, last_pos_rel, state_tuple,
                seq_start_end,obs_date_mask,pred_date_mask):
        """
        Inputs:
...
class TrajectoryGenerator(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end,obs_date_mask, pred_date_mask, user_noise=None):
        """
        Inputs:
        - obs_traj: Tensor of shape (obs_len, batch, 2)
        ...
        # Encode seq
        final_encoder_h = self.encoder(obs_traj_rel,obs_date_mask)[0]
        # Pool States
...
class TrajectoryDiscriminator(nn.Module):
    ...
    def forward(self, traj, traj_rel, seq_start_end,date_mask):
        """
        Inputs:
        ...
        """
        final_h = self.encoder(traj_rel,date_mask)[0]
